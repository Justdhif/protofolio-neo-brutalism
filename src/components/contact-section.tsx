                ...
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <textarea
                        ...
                        placeholder="Hey Nadhif, let's collab on a premium project..."
                  ...
                  >
                    ...
                    <p className="font-sans font-medium text-zinc-600 dark:text-zinc-400 text-sm md:text-base max-w-sm mb-8 leading-relaxed">
                      Thank you! Your project coordinates have been logged successfully. Nadhif will contact you shortly.
                    </p>
