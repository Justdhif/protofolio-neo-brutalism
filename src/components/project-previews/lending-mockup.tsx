...
export default function LendingMockup() {
  ...
  return (
    <div className="space-y-3 h-full flex flex-col text-zinc-800 dark:text-zinc-100 select-none overflow-hidden relative">
      ...
      >
        {/* Automated Scrollable Area including Cards */}
        <div
          ref={scrollRef}
          ...
          <div className="flex flex-col gap-3 pb-4">
            ...
            <div className="grid grid-cols-2 gap-2 shrink-0">
              <motion.div
                ...
                className="bg-white dark:bg-zinc-800/60 rounded-lg border border-zinc-200 dark:border-zinc-700/60 p-2.5 flex flex-col gap-1.5 neo-shadow-sm"
              >
              ...
              <motion.div
                variants={itemVariants}
                className="bg-white dark:bg-zinc-800/60 rounded-lg border border-zinc-200 dark:border-zinc-700/60 p-2.5 flex flex-col gap-1.5 neo-shadow-sm relative overflow-hidden"
              >
                ...
                <span className="text-[6.5px] text-zinc-400 relative z-10">
              ...
              >
                ...
                <div className="bg-white dark:bg-zinc-800/60 rounded-lg border border-zinc-200 dark:border-zinc-700/60 flex flex-col neo-shadow-sm">
                  <div className="p-2 border-b border-zinc-200 dark:border-zinc-700/60 flex justify-between items-center">
                    ...
                    <span className="text-[7.5px] text-blue-500 dark:text-blue-400 font-semibold">
                      View All
                    </span>
                  </div>
                  <div className="p-2 flex flex-col gap-2.5 relative overflow-hidden">
                    <AnimatePresence mode="popLayout">
                      {logList.slice(0, 3).map((log) => (
                        ...
                        >
                          <div
                            className={`w-5 h-5 rounded-full flex shrink-0 items-center justify-center text-[8px] font-bold ${log.bg}`}
                          >
                            {log.initial}
                          </div>
                      ...
                      {peminjamanList.slice(0, 3).map((item) => (
                        ...
                        >
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`text-[6.5px] px-1 py-0.5 rounded font-semibold flex items-center gap-0.5 ${
                                item.status === "Pending"
                                  ? "bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400"
