...
// ==========================================
// 5. MAIN PROJECTS SECTION EXPORT
// ==========================================
            ...
            return (
              ...
              >
                ...
                <div className={`lg:col-span-6 relative group ${isEven ? "lg:order-1" : "lg:order-2"}`}>
                  {/* Outer vibrant glowing halo blur backdrop */}
                  <div
                  ...
                  <motion.div
                    className="relative h-[360px] md:h-[420px] w-full neo-border neo-shadow-lg rounded-2xl bg-white dark:bg-zinc-900 overflow-hidden flex flex-col"
                  >
                    ...
                    <div className="h-10 bg-zinc-150 dark:bg-zinc-900 border-b-2 border-black flex items-center justify-between px-4 shrink-0 transition-colors">
                      {/* Traffic lights with custom hover feedback */}
                      ...
                      {/* Refresh button with micro spin animation */}
                    ...
                    <div className="p-6 flex-1 bg-white dark:bg-zinc-900 flex flex-col justify-center text-zinc-900 dark:text-white relative overflow-hidden transition-colors duration-350">
                      {/* Blueprint Dotted mesh grid overlay */}
                      <div
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2.5 pt-2">
                    {project.tech.map((t, idx) => (
                      ...
                      >
                        {/* Interactive matching indicator dot */}
                        <span
